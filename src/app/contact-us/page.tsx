  ...
  return (
    <div className="bg-gray-900 flex justify-center items-center min-h-screen">
      <div className="bg-gray-900 text-gray-100 min-h-screen w-[80%] px-6 py-8">
        ...
        <section className="mb-8">
          <h2 className="text-3xl font-bold text-indigo-300 mb-4">3. Sales & Enterprise Solutions</h2>
          <p className="text-gray-300">{contactUs.sections.salesEnterpriseSolutions.description}</p>
          <p className="text-gray-300 mt-4">
            <strong>Email:</strong> <a href={`mailto:${contactUs.sections.salesEnterpriseSolutions.email}`} className="text-indigo-400 hover:text-indigo-500">{contactUs.sections.salesEnterpriseSolutions.email}</a>
          </p>
          <p className="text-gray-300 mt-4">{contactUs.sections.salesEnterpriseSolutions.consultations}</p>
        </section>

        {/* Reporting Abuse & Security Issues Section */}
        <section className="mb-8">
          <h2 className="text-3xl font-bold text-indigo-300 mb-4">4. Reporting Abuse & Security Issues</h2>

          {/* Security Vulnerability */}
          <div className="mb-4 ml-4">
            <h3 className="text-xl font-semibold text-indigo-200 mb-2">4.1 Reporting a Security Vulnerability</h3>
          ...
          {/* Misuse or Abuse */}
          <div className="mb-4 ml-4">
            <h3 className="text-xl font-semibold text-indigo-200 mb-2">4.2 Reporting Misuse or Abuse</h3>
        ...
        <section className="mb-8">
          <h2 className="text-3xl font-bold text-indigo-300 mb-4">5. Escalation Process</h2>
        ...
        <section className="mb-8">
          <h2 className="text-3xl font-bold text-indigo-300 mb-4">6. Office Locations</h2>
          ...
          <p className="leading-relaxed ml-6">
            <strong>Email:</strong> <a href={`mailto:${contactUs.sections.officeLocations.headquarters.email}`} className="text-indigo-400 hover:text-indigo-500">{contactUs.sections.officeLocations.headquarters.email}</a>
          </p>
          <p className="leading-relaxed ml-6">
